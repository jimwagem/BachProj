...
# Data params
print('loading data...')
base_dir = "/export/scratch3/jjow/fbp_data/"
input_str = "lim90/"
output_str = "full/"
...
save_dir = './fbpmodels/' + input_str

model_param_path = save_dir + 'modelparam_e99.torch'
start_epoch = model.load(model_param_path) + 1

best_val_err = np.inf
val_err = 0

train_errs = np.load(save_dir + 'train_err_e99.npy').tolist()
val_errs = np.load(save_dir + 'val_err_e99.npy').tolist()
